<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
      <p><b class="pr-2">Email</b> wm500972@gmail.com</p>
      <p>
        <b class="pr-2">GitHub</b>
        <a href="https://github.com/Waynexlink" target="_blank" class="text-violet-400">
          waynexlink
          <sup>
      ...
      <p>
        ...
        <a href="https://x.com/TheDevNetor" target="_blank" class="text-violet-400">
          thedevnetor
          <sup>
            <span class="text-xs scale-75 pl-0.5">
              <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i>
